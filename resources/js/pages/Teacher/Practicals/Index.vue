<template>
    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
            <h2 class="text-xl font-bold" style="color: var(--gl-text-primary)">Practicals</h2>
            <p class="text-sm" style="color: var(--gl-text-secondary)">Manage practical activities.</p>
        </div>
        <button @click="showCreate = true"
            ...
            <Plus class="h-4 w-4" :stroke-width="2" /> New Practical
        </button>
    </div>
