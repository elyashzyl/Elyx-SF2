<template>
    ...
    <div class="flex" style="background-color: #FFFFFF; position: fixed; top: 64px; left: 16rem; right: 0; bottom: 0;">
        <div class="flex w-80 shrink-0 flex-col border-r border-[#E4E6EB]" style="height: 100%;">
        ...
        <div class="flex flex-1 flex-col" style="height: 100%;">
            <template v-if="activeConversation">
                ...
                <div ref="messagesRef" class="flex-1 overflow-y-auto px-4 py-3 messenger-scroll" style="background-color: #F0F2F5; min-height: 0;">
            ...
            <div v-else class="flex flex-1 items-center justify-center" style="background-color: #F0F2F5; min-height: 0;">
