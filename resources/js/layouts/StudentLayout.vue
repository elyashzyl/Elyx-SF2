                ...
                <div class="rounded-xl p-3" style="background: var(--gl-surface-2);">
                    <Link href="/student/profile" class="flex items-center gap-3">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="flex items-center gap-2 text-xs mt-0.5" style="color: var(--gl-text-muted)">
                                <span>Level {{ userLevel }}</span>
                                <span class="w-1 h-1 rounded-full" style="background: var(--gl-text-muted);"></span>
                                <span>{{ totalPoints }} XP</span>
                            </div>
                            <div class="gl-xp-bar mt-1.5" style="height: 3px; border-radius: 2px;">
                                <div class="gl-xp-bar-fill" :style="{ width: xpProgressPct + '%', borderRadius: '2px' }"></div>
                            </div>
                        </div>
